...
WLED_GLOBAL char apPass[65]  _INIT("fuckyourburn");
...
WLED_GLOBAL char apSSID[33] _INIT("T H E   M A N");                             // AP off by default (unless setup)
...
// LED CONFIG
WLED_GLOBAL uint16_t ledCount _INIT(93);          // overcurrent prevented by ABL
...
WLED_GLOBAL byte briS     _INIT(30);                     // default brightness
